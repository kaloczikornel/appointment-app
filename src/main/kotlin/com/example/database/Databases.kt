...
fun Application.configureDatabases(): MongoDatabase {
    ...
    if (!collectionNames.contains("availabilities")) {
        database.createCollection("availabilities")
    }
...
fun Application.connectToMongoDB(): MongoDatabase {
    ...
    val databaseName = environment.config.tryGetString("db.mongo.database.name") ?: "appointment-app"
